-- Five-day rolling academic activity window for the student dashboard.
-- Applied to Supabase as migration: create_five_day_activity_rpc
...
revoke all on function public.get_five_day_activity() from public, anon;
